...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="1">
	...
	<div style="background: #E9ECEF; padding-left: 70px">
		<a href="pages/delegationDetailPage.jsp">Back to Delegation</a>
	</div>
	...
	<div class="card">
		<div class="card-body">
			<div class="container">
				<h1>${requestScope.team.getTname()} Details</h1>
			</div>
		</div>
	</div>
	<div class="card">
		<div class="card-body">
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
						<div class="container">
							<h2>${requestScope.tplayer.getTpname()}</h2>
							<br />
							<div class="card" style="width: 400px">
								<img class="card-img-top" src="${requestScope.tplayer.getTimg()} " alt="Card image"
									style="width: 100%">
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="container">
							<table class="table table-bordered">
								<tbody>
									<tr class="table-primary">
										<th>Full name</th>
										<td>${requestScope.tplayer.getTpname()}</td>
									</tr>
									<tr class="table-success">
										<th>Date of birth</th>
										<td>${requestScope.tplayer.getAge()}</td>
									</tr>
									<tr class="table-danger">
										<th>Delegation team</th>
										<td>${requestScope.team.getTname()}</td>
									</tr>
									<tr class="table-info">
										<th>Playing position</th>
										<td>${requestScope.tplayer.getPosition()}</td>
									</tr>
								</tbody>
							</table>
							<div class="card bg-info text-white">
								<div class="card-body">
									<div class="container">
										<h6>${requestScope.tplayer.getTintro()}</h6>
									</div>
								</div>
							</div>
						</div>
