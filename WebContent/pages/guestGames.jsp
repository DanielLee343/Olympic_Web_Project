				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game1" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game1" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game1" property="partB"/></span> <img class="icon"
				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game2" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game2" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game2" property="partB"/></span> <img class="icon"
				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game3" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game3" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game3" property="partB"/></span> <img class="icon"
				...
				<a class="card-header" style="text-decoration:none" data-toggle="collapse" href="#R1-4">
					...
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game4" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game4" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game4" property="partB"/></span> <img class="icon"
				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game5" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game5" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game5" property="partB"/></span> <img class="icon"
				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game6" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game6" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game6" property="partB"/></span> <img class="icon"
				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game7" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game7" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game7" property="partB"/></span> <img class="icon"
				...
				<div class="d-flex">
					<div class="flex-fill">
						<img class="icon" src="<jsp:getProperty name="game8" property="flagA"/>"> <span
							class="part"><jsp:getProperty name="game8" property="partA"/></span></div>
					<div class="flex-fill">
						<img src="img/VS.png"
							style="height: 60px; padding-left: 20px; float: left">
					</div>
					<div class="flex-fill">
						<span class="part"><jsp:getProperty name="game8" property="partB"/></span> <img class="icon"
...
<script type="text/javascript">
	...
	for(var i = 0 ;i < 8;i++){
		...
		if (gameST[i] == 'finished') {
			...
			html += '<button type="button" class="btn btn-primary" disable style="float: left; margin-left: 60px; margin-top: 15px">Not start</button>';
		}
